...
class CatUnidadesMedida(models.Model):
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
...
class CatTiposInstrumentos(models.Model):
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
    valor = models.CharField(max_length=255)
...
class CatMotivoBaja(models.Model):
    forma_baja  = models.CharField(max_length=45, blank=True, null=True)
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
    default = models.IntegerField(default=0)
    orden = models.IntegerField(default=1)
...
class CatPuestos(models.Model):
    ...
    cat_areas = models.ForeignKey(CatAreas, on_delete=models.DO_NOTHING, null=True, blank=True)

    def __str__(self):
    	if self.cat_areas:
    		return self.cat_areas.codigo + ' - '+ str(self.puesto)
    	else:
        	return self.puesto